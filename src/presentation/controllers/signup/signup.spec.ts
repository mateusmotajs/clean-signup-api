...
describe('SignUp Controller', () => {
  ...
  test('should return 400 status code if no password confirmation is provided', async () => {
    const { sut } = makeSut()
  ...
  test('should return 400 status code if password confirmation fails', async () => {
    const { sut } = makeSut()
  ...
  test('should return 400 status code if an invalid email is provided', async () => {
  ...
  test('should call EmailValidor with a correct email', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('should return 200 status code if valid data is provided to AddAccount', async () => {
    const { sut } = makeSut()
